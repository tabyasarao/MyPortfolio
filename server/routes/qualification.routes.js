...
router.post("/api/qualifications", requireSignin, isAdmin, qualificationCtrl.create);
router.put("/api/qualifications/:qualificationId", requireSignin, isAdmin, qualificationCtrl.update);
router.delete("/api/qualifications/:qualificationId", requireSignin, isAdmin, qualificationCtrl.remove);
